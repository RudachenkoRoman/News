...
import com.rudachenkoroman.astonIntensivFinal.presentation.util.getImageSource

class SourceAdapter(private val onClickSource: (item: Source) -> Unit) : ListAdapter<Source, SourceAdapter.SourceViewHolder>(
    UserDiffUtil
) {
